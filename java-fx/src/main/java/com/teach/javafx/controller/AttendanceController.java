...
public class AttendanceController extends ToolController {
    ...
    protected void onQueryButtonClick() {
        try {
            String url = HttpRequestUtil.serverUrl + "/api/attendance?page=1&size=100";
    ...
    protected void onDeleteButtonClick() {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create(HttpRequestUtil.serverUrl + "/api/attendance/" + id))
                    .DELETE()
                    .header("Authorization", "Bearer " + com.teach.javafx.AppStore.getJwt().getToken())
                    .build();
    ...
    protected void onSaveButtonClick() {
        ...
        try {
            ...
            String url = currentId == null ? HttpRequestUtil.serverUrl + "/api/attendance"
                    : HttpRequestUtil.serverUrl + "/api/attendance/" + currentId;
