...
public class CourseScheduleController {
    ...
    private void initComboBox() {
        ...
        List<OptionItem> teacherOptions = HttpRequestUtil.requestOptionItemList("/api/teacher/getTeacherOptionList", new DataRequest());
        ...
        List<OptionItem> classOptions = HttpRequestUtil.requestOptionItemList("/api/classEntity/getClassOptionList", new DataRequest());
