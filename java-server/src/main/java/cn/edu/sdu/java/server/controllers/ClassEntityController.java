...
public class ClassEntityController {
    ...
    @PostMapping("/getClassOptionList")
    public OptionItemList getClassOptionList(@RequestBody DataRequest dataRequest) {
        List<ClassEntity> classList = classEntityRepository.findAll();
        List<OptionItem> itemList = new ArrayList<>();
        for (ClassEntity c : classList) {
            itemList.add(new OptionItem(c.getClassId(), c.getClassId() + "", c.getClassNum() + "-" + c.getClassName()));
        }
